...
<html lang="en">
  ...
  <head>
    ...
    <link href="/frontend/css/grayscale.min.css" rel="stylesheet">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">FILA STORE</a>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <h1 class="brand-heading">FILA STORE</h1>
              <p class="intro-text">EaSY
                <br>forever young.</p>
    ...
    <script src="/frontend/js/grayscale.min.js"></script>
